...
export default function SignInPage() {
  return (
    <div
      className="relative -mt-16 flex min-h-svh items-center justify-center overflow-hidden p-6"
      style={{
        backgroundImage: `
    ...
    >
      ...
      <motion.svg
        aria-hidden
        viewBox="0 0 200 200"
        className="pointer-events-none absolute bottom-0 left-0 w-56 opacity-70"
      ...
      >
        <polygon
          points="0,60 80,0 200,20 200,140 120,200 0,180"
          fill="#fde047"
          stroke="black"
          strokeWidth="5"
        />
      ...
      <motion.svg
        aria-hidden
        viewBox="0 0 200 200"
        className="pointer-events-none absolute top-10 right-0 w-40 opacity-60"
        initial={{ opacity: 0, scale: 0.7 }}
