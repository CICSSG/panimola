    ...
    <GridBackground className="mb-32 flex flex-col gap-6 py-4">
      ...
      <div className="mx-4 grid max-w-7xl gap-8 md:grid-cols-2 xl:mx-auto xl:gap-16">
        {Organizations.map((org, index) => (
          <div className="relative h-fit w-full max-w-lg min-w-0 flex-1">
            {/* Window title bar */}
            <div className="relative z-2">
              ...
              <div className="h-full border-2 border-black bg-white p-4">
                ...
                <Link
                  ...
                  className="mt-4 inline-block border border-black bg-[#fef085] px-4 py-3 text-center text-black hover:bg-[#fef085]/80 hover:scale-102 hover:translate-y-0.5 transition-all duration-300"
                  style={{ boxShadow: "6px 6px 0 black" }}
                >
                  <div className="font-blackhansans -rotate-2">View Organization</div>
                </Link>
              </div>
            </div>
